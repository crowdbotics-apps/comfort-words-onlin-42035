"""
Django settings for comfort_words_onlin_42035 project.
...
ROOT_URLCONF = 'comfort_words_onlin_42035.urls'
...
WSGI_APPLICATION = 'comfort_words_onlin_42035.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "comfort_words_onlin_42035 API",
    "DESCRIPTION": "API documentation for comfort_words_onlin_42035 App",
    "VERSION": "v1",
}
