...
## Project Structure
    ...
    ├── comfort_words_onlin_42035  # Django project configurations
...
1. Clone this repo and `cd comfort_words_onlin_42035`
...
2. Clone this repo and `cd comfort_words_onlin_42035`
